...
class ControlsWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.controlGroupBox = QtWidgets.QGroupBox()
        self.controlGroupBox.setTitle("Control")
        self.controlGroupBox.setMinimumWidth(140)
        self.controlGroupBox.setMaximumWidth(140)
        ...
        self.stopPushButton.setMinimumHeight(100)
        ...
        layout = QtWidgets.QVBoxLayout(self.controlGroupBox)
        layout.addWidget(self.startPushButton)
        layout.addWidget(self.stopPushButton)
        layout.addWidget(self.ctsCheckBox)
        layout.addWidget(self.shuntBoxCheckBox)
        layout.addStretch()
        ...
        layout = QtWidgets.QHBoxLayout(self.tab)
        ...
        self.multiFilterEnableLabel = QtWidgets.QLabel()
        self.multiFilterEnableLabel.setText("Enable")

        self.multiFilterEnableComboBox = QtWidgets.QComboBox()
        self.multiFilterEnableComboBox.addItem("Off")
        self.multiFilterEnableComboBox.addItem("On")

        self.multiFilterTypeLabel = QtWidgets.QLabel()
        self.multiFilterTypeLabel.setText("Type")

        self.multiFilterTypeComboBox = QtWidgets.QComboBox()
        self.multiFilterTypeComboBox.addItem("Repeat")
        self.multiFilterTypeComboBox.addItem("Moving")

        self.multiFilterCountLabel = QtWidgets.QLabel()
        self.multiFilterCountLabel.setText("Count")

        self.multiFilterCountSpinBox = QtWidgets.QSpinBox()
        self.multiFilterCountSpinBox.setMinimum(0)
        self.multiFilterCountSpinBox.setMaximum(100)
        self.multiFilterCountSpinBox.setValue(10)

        self.multiFilterGroupBox = QtWidgets.QGroupBox()
        self.multiFilterGroupBox.setTitle("Filter")
        self.multiFilterGroupBox.setMinimumWidth(140)

        layout = QtWidgets.QVBoxLayout(self.multiFilterGroupBox)
        layout.addWidget(self.multiFilterEnableLabel)
        layout.addWidget(self.multiFilterEnableComboBox)
        layout.addWidget(self.multiFilterTypeLabel)
        layout.addWidget(self.multiFilterTypeComboBox)
        layout.addWidget(self.multiFilterCountLabel)
        layout.addWidget(self.multiFilterCountSpinBox)
        ...
        layout = QtWidgets.QHBoxLayout(self.multi)
        layout.addWidget(self.multiFilterGroupBox)
        ...
        self.tabWidget.addTab(self.tab, "General")
        self.tabWidget.addTab(self.multi, "Multimeter")
        ...
        self.gridLayout.addWidget(self.controlGroupBox, 0, 0, 1, 1)
        ...
        self.multiFilterEnableComboBox.currentIndexChanged.connect(self.onFilterEnableChanged)
        self.multiFilterTypeComboBox.currentIndexChanged.connect(lambda: self.filterTypeChanged.emit(self.filterType()))
        self.multiFilterCountSpinBox.editingFinished.connect(lambda: self.filterCountChanged.emit(self.filterCount()))
    ...
    def filterEnable(self):
        ...
        return bool(self.multiFilterEnableComboBox.currentIndex())

    def setFilterEnable(self, enabled):
        """Set filter enable state."""
        self.multiFilterEnableComboBox.setCurrentIndex(int(enabled))

    def filterType(self):
        """Returns filter type."""
        return self.multiFilterTypeComboBox.currentText().lower()

    def setFilterType(self, type):
        """Set filter type."""
        index = self.multiFilterTypeComboBox.findText(type.title())
        if index < 0:
            index = 0
        self.multiFilterTypeComboBox.setCurrentIndex(index)

    def filterCount(self):
        """Returns filter count."""
        return self.multiFilterCountSpinBox.value()

    def setFilterCount(self, count):
        """Set filter count."""
        self.multiFilterCountSpinBox.setValue(count)
    ...
    def onFilterEnableChanged(self):
        ...
        self.multiFilterTypeComboBox.setEnabled(enabled)
        self.multiFilterCountSpinBox.setEnabled(enabled)
    ...
    def onStart(self):
        ...
        self.multiFilterEnableComboBox.setEnabled(False)
        self.multiFilterTypeComboBox.setEnabled(False)
        self.multiFilterCountSpinBox.setEnabled(False)
    ...
    def onHalted(self):
        ...
        self.multiFilterEnableComboBox.setEnabled(True)
        self.multiFilterTypeComboBox.setEnabled(True)
        self.multiFilterCountSpinBox.setEnabled(True)
