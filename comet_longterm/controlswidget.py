...
class ControlsWidget(QtWidgets.QWidget, UiLoaderMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        index = settings.value('currentOperator', 0)
    ...
    def onStart(self):
        ...
        self.ui.ivEndSpinBox.setEnabled(False)
        self.ui.ivStepSpinBox.setEnabled(False)
        self.ui.biasSpinBox.setEnabled(False)
    ...
    def onHalted(self):
        ...
        self.ui.ivEndSpinBox.setEnabled(True)
        self.ui.ivStepSpinBox.setEnabled(True)
        self.ui.biasSpinBox.setEnabled(True)
